/* This file is mainly a copy of the code for the Adafruit Wave Shield.
The original files for this can be found at https://waverp.googlecode.com/files/waverp20110923.zip
via the Adafruit site. 

Changes to the code all revolve around allowing the user to control the code via the buttons on the ball -
This means there is no Serial input.

Functions I changed / added to can be searched by finding "BMCHANGE"
 ...
 * www.sdcard.org/consumerss/formatter/
 *
